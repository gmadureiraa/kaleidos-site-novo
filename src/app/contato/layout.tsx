...
export async function generateMetadata(): Promise<Metadata> {
  return generateSEOMetadata({
    ...
    description: "Agende um diagnóstico com a Kaleidos, agência cripto-nativa desde 2019. Marketing de conteúdo, growth e IA para projetos de cripto, web3 e fintech.",
