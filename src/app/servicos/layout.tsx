...
export async function generateMetadata(): Promise<Metadata> {
  return generateSEOMetadata({
    ...
    description:
      "Marketing de conteúdo, Kaleidos AI e growth & lançamentos. A agência cripto-nativa que cobre a stack completa: conteúdo, design, vídeo, newsletter, tráfego pago e desenvolvimento.",
    keywords:
