...
export default function KaleidosIAPage() {
  ...
  return (
    ...
    >
      ...
      {/* 8. PRICING                                                        */}
      {/* ================================================================ */}
      <PricingSection onCta={(t) => handleWhatsApp(`pricing_${t}`)} />
...
function PricingSection({ onCta }: { onCta: (tier: string) => void }) {
  const tiers = [
    {
      name: "Diagnóstico",
      price: "R$ 5.000",
      ...
      description:
        "Ponto de partida. A Kaleidos audita teu fluxo, mapeia gargalos, entrega plano de ação priorizado por ROI.",
      bullets: [
        "1 dia de imersão com o time",
        "Mapa de gargalos com 3-5 alvos prioritários",
        "Estimativa de hora liberada por mês",
        "Crédito integral pro plano mensal se contratar em 30 dias",
      ],
    ...
    },
    {
      ...
      cadence: "/mês · mín. 3 meses",
      description:
        "Implementação contínua. Time da Kaleidos toca os gargalos prioritários em sprints quinzenais.",
      bullets: [
        "2-3 implementações de IA por sprint",
        "Time multidisciplinar dedicado (estratégia + dev + copy)",
        "Código no repositório do cliente",
    ...
    },
    {
      ...
      cadence: "sob escopo",
      description:
        "Pipeline de IA construído sob medida. Pra quem quer um produto de IA dentro da própria empresa.",
      bullets: [
        "Discovery + arquitetura + build",
        "Stack TS + Python + Supabase + Gemini/Claude",
        "Entrega como sistema, não como relatório",
        "Documentação + handoff técnico",
      ],
  ...
  return (
    ...
    >
      <div className="mb-10 max-w-3xl">
        ...
        <h2 className="font-display text-3xl font-semibold text-white sm:text-4xl">
          Três jeitos de trabalhar com a Kaleidos AI.
        </h2>
        <p className="mt-4 text-base text-gray-400">
          A maioria começa pelo diagnóstico. Quem já mapeou o gargalo entra
          direto no mensal. Caso de plataforma própria, sistema custom.
        </p>
      </div>
