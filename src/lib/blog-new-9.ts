...
export const blogNew9: BlogPost[] = [
  {
    ...
    seoDescription:
      "Guia da Kaleidos de crescimento orgânico no Twitter (X) para projetos cripto: perfil, threads, cadência, reply estratégico, Spaces, KOLs e como medir mindshare.",
    category: "growth",
    author: AUTHOR,
    ...
    tldr:
      "No cripto, o Twitter (X) é a praça pública onde narrativa vira liquidez. Crescimento orgânico vem de perfil claro, threads e bastidores consistentes, cadência diária, reply estratégico, Spaces e KOLs bem escolhidos. Meça mindshare e engajamento qualificado, nunca seguidores comprados.",
    faq: [
      {
        question: "Por que o Twitter (X) é tão importante para projetos cripto?",
        answer:
          "Porque é onde a comunidade cripto vive em tempo real. Fundadores, traders, VCs, devs e mídia discutem lançamentos, narrativas e teses no X antes de qualquer outro canal. Para um projeto web3, estar ausente do X é estar fora da conversa que move atenção e liquidez.",
      },
      {
        question: "Quantas vezes por dia um projeto cripto deve postar no X?",
        answer:
          "Uma base saudável é de 2 a 4 posts originais por dia mais respostas em conversas relevantes. O que importa não é o volume bruto, e sim a consistência diária. É melhor postar 3 coisas boas todo dia do que 15 num dia e sumir por uma semana.",
      },
      {
        question: "Vale a pena comprar seguidores ou usar engagement farming?",
        answer:
          "Não. Comprar seguidores infla vaidade e destrói o alcance real, porque o algoritmo do X pesa engajamento qualificado, não número de followers. Engagement farming (gm, giveaways vazios, raids) atrai caçadores de airdrop, não usuários. A conta fica grande e morta.",
      },
      {
        question: "O que é mindshare e por que medir isso em vez de seguidores?",
        answer:
          "Mindshare é a fatia de atenção que seu projeto ocupa nas conversas do seu nicho: quantas pessoas relevantes falam de você, em que tom e com que frequência. É um sinal muito mais próximo de valor real do que seguidores, que são uma métrica de vaidade fácil de manipular.",
      },
      {
        question: "Preciso de KOLs para crescer no Twitter cripto?",
        answer:
          "KOLs aceleram, mas não substituem base própria. Sem um perfil forte e conteúdo consistente, a amplificação de um influenciador vira pico sem retenção. O caminho é construir autoridade orgânica primeiro e usar KOLs para ampliar algo que já funciona.",
      },
    ],
    content: `# Twitter (X) para projetos cripto: o guia de crescimento orgânico

No cripto, o Twitter (X) não é mais uma rede social. É a praça pública do setor.

É onde a tese nasce, onde a narrativa se forma e onde a atenção vira liquidez. Um lançamento de token, um exploit, um airdrop, uma nova narrativa de mercado: tudo aparece primeiro no X, quase sempre horas antes da imprensa. Fundadores, traders, devs, fundos e a mídia especializada vivem nesse feed em tempo real.

Para um projeto web3, a conta é simples. Se você não está na conversa do X, você não existe para o público que decide onde a atenção e o capital vão parar.

A Kaleidos trabalha com projetos cripto todos os dias. E a lição mais repetida é essa: crescimento orgânico no X é o ativo de marketing mais subvalorizado do setor. Este guia mostra como construir esse ativo do zero, sem atalhos que quebram.
...
1. **Pinned tweet é território nobre.** Ele deve fazer o trabalho de vendas quando você não está por perto. Atualize sempre que houver algo mais forte para mostrar.
2. **Consistência visual.** Foto, banner e tom precisam parecer o mesmo projeto do site e do Discord. Fragmentação de identidade lê como amadorismo.
3. **Verificação e handle coerente.** Handle igual ao do site e das outras redes reduz risco de golpe e facilita ser encontrado. Em cripto, onde impersonação é praga, coerência é confiança.
