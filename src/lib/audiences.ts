...
export const AUDIENCES: Audience[] = [
  ...
  },
  {
    ...
    subHtml:
      'A Kaleidos é o time de marca, conteúdo e go-to-market de projetos cripto desde 2020. <strong style="color:#14110D;">30M+ de views</strong> e <strong style="color:#14110D;">+R$30mi</strong> gerados pra clientes como Crypto.com, Mercado Bitcoin e Ledger.',
