...
export const AUDIENCES: Audience[] = [
  ...
  },
  {
    ...
    subHtml:
      'A Kaleidos leva a criatividade e o rigor do mercado cripto pra qualquer empresa: conteúdo que conecta, estratégia que sustenta, <strong style="color:#14110D;">resultado que aparece</strong> no negócio dos nossos clientes.',
...
const AUDIENCES_EN: Record<string, AudienceEnOverride> = {
  ...
  empresas: {
    ...
    subHtml:
      'Kaleidos brings the creativity and rigor of the crypto market to any company: content that connects, strategy that lasts, <strong style="color:#14110D;">results that show</strong> in the businesses of our clients.',
    pains: [
      {
