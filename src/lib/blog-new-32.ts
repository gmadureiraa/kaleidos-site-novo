...
export const blogNew32: BlogPost[] = [
  {
    ...
    seoDescription:
      "Por que o marketing web3 virou uma arte perdida: os erros do playbook de 2021 (hype, airdrop farm, KOL genérico) e os fundamentos que voltaram a decidir o jogo.",
    category: "cripto",
    author: AUTHOR,
    ...
    tldr: "Web3 marketing virou uma arte perdida porque a maioria dos projetos copia o playbook de 2021: hype fabricado, airdrops que atraem mercenários e KOLs pagos genéricos. O que voltou a decidir o jogo são os fundamentos: posicionamento claro, utilidade real, comunidade de verdade e narrativa que sobrevive ao ciclo. Marketing como fundamento, não como campanha, constrói projetos que duram.",
    faq: [
      {
        question: "Por que o marketing web3 é considerado uma arte perdida?",
        answer:
          "Porque as táticas que funcionaram no bull market de 2021, como hype de lançamento, promessas de valorização e campanhas de airdrop, pararam de gerar resultado sustentável, mas continuam sendo copiadas. Os fundamentos de marketing que realmente constroem projetos duráveis, como posicionamento, utilidade e comunidade real, foram deixados de lado pela maioria do mercado.",
      },
      {
        question: "Quais são os erros mais comuns de marketing em projetos web3?",
        answer:
          "Os principais são: usar airdrop como estratégia de aquisição em vez de recompensa por uso real, contratar KOLs genéricos sem afinidade com o produto, confundir métricas de vaidade (seguidores, membros no Discord) com tração, comunicar apenas para quem já está dentro do nicho e não ter posicionamento claro que explique por que o projeto existe.",
      },
      {
        question: "Airdrop ainda funciona como estratégia de marketing?",
        answer:
          "Funciona quando recompensa comportamento real e alinhado ao produto, como fez a Hyperliquid em 2024 ao distribuir tokens para usuários genuínos da plataforma. Não funciona quando é desenhado para inflar métricas: nesse caso atrai farmers profissionais que vendem o token no primeiro dia e abandonam o projeto, deixando gráficos de retenção em queda livre.",
      },
      {
        question: "O que é marketing de fundamentos em web3?",
        answer:
          "É construir a base antes da amplificação: posicionamento que explica o problema que o projeto resolve, produto com utilidade que sobrevive sem incentivo financeiro, comunidade formada por usuários reais e não por caçadores de recompensa, e uma narrativa consistente que educa o mercado ao longo do tempo, em vez de depender de picos de hype.",
      },
      {
        question: "Como a Kaleidos aborda marketing para projetos web3?",
        answer:
          "A Kaleidos trabalha marketing cripto a partir dos fundamentos: diagnóstico de posicionamento e narrativa, estratégia de conteúdo que constrói autoridade, comunidade tratada como produto e distribuição pensada para alcançar quem está fora da bolha. A tese é que marketing em web3 é trabalho de construção contínua, não uma campanha de lançamento.",
      },
    ],
    content: `# Web3 marketing é uma arte perdida: onde os projetos erram

Existe um paradoxo incômodo no mercado cripto: a indústria que mais fala sobre inovação é a que menos inova em marketing. Abra o pitch de dez projetos web3 lançados este ano e você vai encontrar o mesmo roteiro: teaser misterioso no X, programa de pontos, campanha de airdrop, meia dúzia de KOLs pagos postando o mesmo texto e um Discord inflado de gente esperando o snapshot. É o playbook de 2021 rodando em loop, cinco anos depois, num mercado que já provou várias vezes que ele não funciona mais.

A tese da Kaleidos é direta: web3 marketing virou uma arte perdida. Não porque falte dinheiro, talento ou canal. Mas porque a maioria dos projetos confundiu tática de bull market com estratégia de marketing, e nunca aprendeu (ou desaprendeu) os fundamentos que fazem qualquer produto ser adotado: posicionamento, utilidade, comunidade real e narrativa. Quem recuperar essa arte primeiro vai construir os projetos que sobrevivem ao próximo ciclo. Quem continuar copiando 2021 vai continuar financiando liquidez de saída para farmers profissionais.
