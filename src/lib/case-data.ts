...
export const casesData: Record<string, CaseData> = {
  ...
  "matheus-fassheber": {
    ...
    nome: "Matheus Fassheber (NBS Finance)",
    status: "em-andamento",
    tags: ["Marca Pessoal", "Founder", "Fintech", "Cripto", "Instagram"],
    descricao: "Founder brand pessoal do Matheus Fassheber (@matheusfassheber), fundador da NBS Finance: o CEO como criador de conteúdo. O produto aqui é a figura dele, não a conta da empresa — founder-led growth pra gerar pipeline qualificado a custo baixo.",
    descricao_en: "Personal founder brand of Matheus Fassheber (@matheusfassheber), founder of NBS Finance: the CEO as a content creator. The product here is him, not the company account — founder-led growth to generate qualified pipeline at low cost.",
    ...
    media: [
      ...
      // 2026-08-06 · Institucional — conheça a NBS Finance
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-01.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (capa)", link: "https://www.instagram.com/matheusfassheber/" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-02.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 2/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-03.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 3/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-04.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 4/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-05.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 5/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-06.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 6/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-07.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 7/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-08.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 8/9)" },
      { src: "/portfolio/matheus-fassheber/2026-08-06-institucional-conheca-de-uma-vez-por-todas-a-neo-09.jpg", type: "image", alt: "Carrossel Matheus Fassheber — Institucional — conheça a NBS Finance (slide 9/9)" },
