...
O caso que melhor ilustra as três camadas é o da MakerDAO. Em agosto de 2024 o protocolo lançou o [rebrand para Sky que a comunidade rejeitou](/blog/sky-maker-rebrand-que-a-comunidade-rejeitou), com novo token SKY conversível a partir de MKR na proporção de 1 para 24.000. A reação de parte relevante da comunidade foi tão negativa que semanas depois o cofundador Rune Christensen admitiu publicamente que a mudança poderia ser revertida e levou a discussão de volta à governança (Fonte: [CoinDesk, 2024](https://www.coindesk.com/business/2024/09/25/makerdaos-rebranding-to-sky-might-be-reversed-founder-says/)). Um dos protocolos mais respeitados do DeFi, com anos de governança madura, subestimou o apego da comunidade ao nome Maker. Se aconteceu com eles, acontece com qualquer um.
