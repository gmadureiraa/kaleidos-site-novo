...
export const blogNew3: BlogPost[] = [
  {
    ...
    seoDescription:
      "Teardown de marketing do Nubank pela Kaleidos: posicionamento anti-banco, branding roxo, atendimento e boca-a-boca. Cada lição traduzida para cripto e web3.",
    category: "cases",
    author: AUTHOR,
    ...
    readTime: 11,
    featured: false,
    coverImage: "/blog/nubank-teardown-marketing-marca/cover.png",
    tags: [
      "Nubank",
      "marketing de marca",
      "fintech",
    ...
    tldr:
      "O Nubank cresceu construindo marca, não só produto: posicionamento anti-banco, identidade roxa inconfundível, atendimento tratado como marketing e crescimento por indicação. A Kaleidos desmonta essas jogadas e mostra como projetos cripto podem aplicar cada uma para criar autoridade e comunidade real.",
    faq: [
      {
        question: "Quando o Nubank foi fundado e quando abriu capital?",
        answer:
          "O Nubank foi fundado em 2013 por David Vélez, Cristina Junqueira e Edward Wible. Abriu capital na Bolsa de Nova York em dezembro de 2021, em um dos maiores IPOs de fintech da história, avaliado em torno de US$ 41 bilhões (Reuters, 2021).",
      },
      {
        question: "Qual foi a principal jogada de marketing do Nubank?",
        answer:
          "O posicionamento anti-banco. O Nubank não vendeu um cartão, vendeu a revolta contra tarifas, filas e burocracia dos bancos tradicionais. A marca virou o símbolo de quem estava cansado do sistema, e isso guiou identidade, atendimento e comunicação.",
      },
      {
        question: "Por que o roxo é tão importante para a marca Nubank?",
        answer:
          "O roxo é um ativo de marca proprietário. Nenhum banco grande usava a cor, então o Nubank a ocupou por inteiro e ganhou o apelido de roxinho. A cor virou atalho mental: o cliente reconhece a marca antes de ler o nome.",
      },
      {
        question: "Como o Nubank cresceu sem gastar tanto em mídia paga no início?",
        answer:
          "Por boca-a-boca e lista de espera com convites. O produto e o atendimento geravam recomendação espontânea, e o sistema de convites transformava cada cliente em canal de aquisição. A escassez controlada aumentava o desejo.",
      },
      {
        question: "O que projetos cripto podem aprender com o Nubank?",
        answer:
          "Que marca é infraestrutura de crescimento, não enfeite. Posicionamento claro, identidade proprietária, suporte tratado como marketing e comunidade que indica valem mais que qualquer campanha isolada. Em cripto, confiança é o produto, e marca é como se constrói confiança.",
      },
    ],
    content: `# Como o Nubank construiu a marca: teardown de marketing para projetos cripto

O Nubank não venceu porque tinha o melhor cartão de crédito. Venceu porque construiu a marca mais forte do setor financeiro brasileiro em uma década.

Fundado em 2013 por David Vélez, Cristina Junqueira e Edward Wible, o Nubank abriu capital na Bolsa de Nova York em dezembro de 2021, em um dos maiores IPOs de fintech da história, com avaliação em torno de US$ 41 bilhões (Reuters, 2021). Poucos anos depois, a empresa reportou mais de 100 milhões de clientes na América Latina (Nubank, relatório de resultados, 2024).

A Kaleidos estuda casos assim porque a mecânica se repete. O que fez o Nubank crescer não foi só tecnologia. Foi marketing de marca executado com disciplina. E projetos cripto, que vivem e morrem de confiança e comunidade, têm muito a aprender com isso.

Este é um teardown. A Kaleidos desmonta as jogadas, uma a uma, e traduz cada lição pro contexto de web3.
