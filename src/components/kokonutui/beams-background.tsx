...
function createBeam(width: number, height: number, isDarkMode: boolean): Beam {
    ...
    const hueBase = isDarkMode ? 120 : 130; // Verde base
    const hueRange = isDarkMode ? 40 : 30; // Variação de verde
...
export default function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function resetBeam(beam: Beam, index: number, totalBeams: number) {
            ...
            const hueBase = isDarkModeRef.current ? 120 : 130; // Verde base
            const hueRange = isDarkModeRef.current ? 40 : 30; // Variação de verde
        ...
        >
            ...
            <div className="relative z-10 flex h-screen w-full items-center justify-center">
                <div className="flex flex-col items-center justify-center gap-6 px-4 text-center">
                    <motion.h1
                        className="text-6xl md:text-7xl lg:text-8xl font-semibold text-black tracking-tighter"
