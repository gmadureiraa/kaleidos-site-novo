...
import { categoryLabels, formatDate } from "@/lib/blog-data";
import { useI18n } from "@/i18n/useI18n";
import { useAnalytics } from "@/components/analytics";

/**
 * Seção dupla perto do fim da home:
 ...
 * Puxa de blog-data e papers-data, respeitando o flag `hidden` dos papers.
 */
export function HomeResources() {
  ...
  // Só posts já publicados (publishedAt <= agora): posts agendados não entram no carrossel.
