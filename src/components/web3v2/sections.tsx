...
<section id="topo" class="w3-hero" style="position:relative;display:flex;flex-direction:column;justify-content:center;background:#FAFAFA;background-image:linear-gradient(#14110D0d 1px,transparent 1px),linear-gradient(90deg,#14110D0d 1px,transparent 1px);background-size:34px 34px;overflow:hidden;">
    <div class="w3-herodeco" style="position:absolute;inset:0;pointer-events:none;">
      ...
      <img src="/v2/collage/sticker-bitcoin.png" alt="" loading="lazy" decoding="async" style="position:absolute;left:5%;bottom:10%;width:clamp(96px,10vw,148px);filter:drop-shadow(3px 5px 7px rgba(20,17,13,.16));transform:rotate(-8deg);animation:floatrotL 7.5s ease-in-out infinite;">
      <img src="/v2/collage/sticker-tothemoon.png" alt="" loading="lazy" decoding="async" style="position:absolute;right:3%;top:11%;width:clamp(120px,13vw,188px);filter:drop-shadow(3px 5px 7px rgba(20,17,13,.16));transform:rotate(6deg);animation:floatrotR 9s ease-in-out infinite;">
